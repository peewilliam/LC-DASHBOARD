...
!(function (e, t) {
 ...
 return (function () {
   ...
   fn: function (e) {
    ...
    if (u && f) {
     var v = (function (e, t) {
      ...
      _ = "y" === h ? o : a,
      y =
       n.rects.reference[p] + n.rects.reference[h] - f[h] - n.rects.popper[p],
   ...
   if (p) {
    ...
    C === S(n) &&
     ...
     (c === r || ((c === s || c === a) && l === f)) &&
      ((O = o),
      (b -=
       (m && C === T && T.visualViewport ? T.visualViewport.height : C[x]) -
       i.height),
      (b *= h ? 1 : -1)),
     (c !== s && ((c !== r && c !== o) || l !== f)) ||
      ((A = a),
      (_ -=
       (m && C === T && T.visualViewport ? T.visualViewport.width : C[L]) -
       i.width),
      (_ *= h ? 1 : -1));
   }
   var j,
  ...
  var je,
   Pe = Le(),
   De = Le({ defaultModifiers: [oe, Ae, ie, D, Ee, ye, Oe, Z, ke] }),
   Ie = Le({ defaultModifiers: [oe, Ae, ie, D] });
  function Ne() {
   return (
    (Ne =
     "undefined" != typeof Reflect && Reflect.get
      ...
      : function (e, t, n) {
         var i = (function (e, t) {
          for (
           ;
           !Object.prototype.hasOwnProperty.call(e, t) && null !== (e = We(e));
     ...
     if (null != n) {
      ...
      try {
       if (((o = (n = n.call(e)).next), 0 === t)) {
        ...
        for (
         ;
         !(c = (i = o.call(n)).done) && (s.push(i.value), s.length !== t);
         c = !0
        );
      } catch (e) {
       (l = !0), (r = e);
  ...
  var Ht = function (e, t, n) {
      ...
      [
       ...
       },
       {
        ...
        value: function (e, t) {
         ...
         return qe(
          qe(
           qe(qe({}, this.constructor.Default), "object" === et(n) ? n : {}),
           ot(t) ? Rt(t) : {}
          ),
          "object" === et(e) ? e : {}
         );
      ...
      [
       ...
       },
       {
        ...
        value: function (e) {
         ...
         return (
          this.getInstance(e) || new this(e, "object" === et(t) ? t : null)
         );
        },
       },
       {
   ...
   Qt = function (e) {
    ...
    It.on(document, n, '[data-bs-dismiss="'.concat(i, '"]'), function (n) {
     if (
      (["A", "AREA"].includes(this.tagName) && n.preventDefault(), !ct(this))
     ) {
       ...
       },
       {
        ...
        value: function () {
         ...
         if (!(e <= 40)) {
          ...
          (this._deltaX = 0),
           t &&
            mt(t > 0 ? this._config.rightCallback : this._config.leftCallback);
         }
        },
       },
       {
   ...
   _i = (function (e) {
    ...
    function i(e, n) {
     ...
     return (
      ...
      (r._menu =
       Kt.next(r._element, li)[0] ||
       Kt.prev(r._element, li)[0] ||
       Kt.findOne(li, r._parent)),
       ...
       },
       {
        ...
        value: function (e) {
         if (
          "object" ===
           et(
            (e = Ne(We(i.prototype), "_getConfig", this).call(this, e))
             .reference
           ) &&
          !ot(e.reference) &&
  ...
  var yi = "backdrop",
   ...
   Zi = (function (e) {
    ...
    function n(e, i) {
     ...
     return (
      Ke(this, n),
      ((r = t.call(this, e, i))._dialog = Kt.findOne(
       ".modal-dialog",
       r._element
      )),
      ...
      [
       ...
       },
       {
        ...
        value: function (e) {
         ...
         this._isShown ||
          this._isTransitioning ||
          It.trigger(this._element, Wi, { relatedTarget: e })
           .defaultPrevented ||
          ((this._isShown = !0),
          (this._isTransitioning = !0),
       ...
       },
       {
        ...
        value: function () {
         ...
         It.on(this._element, pr, function (t) {
          "Escape" === t.key &&
           (e._config.keyboard ? e.hide() : It.trigger(e._element, ur));
         });
        },
       },
      ],
        ...
        value: function (e) {
         for (var t = 0, i = Object.entries(e); t < i.length; t++) {
          var r = Ye(i[t], 2),
           o = r[0],
           a = r[1];
          Ne(We(n.prototype), "_typeCheckConfig", this).call(
           this,
           { selector: o, entry: a },
           Ar
          );
         ...
         return this._config.sanitize
          ? (function (e, t, n) {
             ...
             var r,
              ...
              a = $e(
               (i = []).concat.apply(i, Ge(o.body.querySelectorAll("*")))
              );
             try {
              for (a.s(); !(r = a.n()).done; ) {
               var s,
      ...
      [
        ...
        value: function () {
         ...
         if (this._isWithContent() && this._isEnabled) {
          var t = It.trigger(this._element, this.constructor.eventName("show")),
           n = (
            lt(this._element) || this._element.ownerDocument.documentElement
       ...
       },
       {
        ...
        value: function () {
         ...
         if (
          this._isShown() &&
          !It.trigger(this._element, this.constructor.eventName("hide"))
           .defaultPrevented
         ) {
          if (
       ...
       },
       {
        ...
        value: function (e) {
         ...
         return (
          t.setAttribute("id", n), this._isAnimated() && t.classList.add(Cr), t
         );
        },
       },
       {
           ...
           if ("click" === i)
            ...
            It.on(this._element, r, this._config.selector, function (e) {
             ...
             It.on(this._element, o, this._config.selector, function (e) {
              var n = t._initializeOnDelegatedTarget(e);
              (n._activeTrigger["focusout" === e.type ? Pr : jr] =
       ...
       },
       {
        ...
        value: function (e) {
         for (
          var t = Rt(this._element), n = 0, i = Object.keys(t);
          n < i.length;
          n++
         ) {
          var r = i[n];
       ...
       },
       {
        ...
        value: function (e) {
         return (
          (e.container = !1 === e.container ? document.body : at(e.container)),
      ...
      [
       ...
       },
       {
        ...
        value: function () {
         var e;
         return (
          Ve((e = {}), ".popover-header", this._getTitle()),
       ...
       },
       {
        ...
        value: function (e) {
         this._activeTarget !== e &&
          ...
          It.trigger(this._element, Wr, { relatedTarget: e }));
        },
       },
       {
        ...
        value: function (e) {
         if (e.classList.contains("dropdown-item"))
          Kt.findOne(".dropdown-toggle", e.closest(".dropdown")).classList.add(
           Vr
          );
         else {
          var t,
       ...
       },
       {
        ...
        value: function (e) {
         if ([oo, ao, so, co, lo, uo].includes(e.key)) {
          ...
          t &&
           (t.focus({ preventScroll: !0 }), n.getOrCreateInstance(t).show());
         }
        },
       },
       {
