         ...
         value: function (e) {
          ...
          if (e !== this.settings.lang || a) {
           ...
           for (
            ...
            r[l].querySelector(".template-customizer-theme-name").textContent =
             o[u] || this._getThemeByName(u).title;
           }
         ...
         value: function () {
          ...
          "" !== u
           ...
           this._hasControls("style") ||
            (this.settings.style = z.contains("dark-style") ? "dark" : "light"),
           this._hasControls("contentLayout") ||
         ...
         value: function () {
          ...
          if (this._hasControls("style")) {
           this.settings.availableStyles.forEach(function (t) {
            ...
            d
             .querySelector(
              'input[value="'.concat(this.settings.stylesOpt, '"]')
             )
          ...
          if (
           ...
           if (this._hasControls("headerType")) {
            ...
            setTimeout(function () {
             ...
             w
              .querySelector(
               'input[value="'.concat(this.settings.headerType, '"]')
              )
              .setAttribute("checked", "checked");
            var k = function (e) {
           ...
           if (this._hasControls("contentLayout")) {
            ...
            this.settings.availableContentLayouts.forEach(function (t) {
             ...
             T.querySelector(
              'input[value="'.concat(this.settings.contentLayout, '"]')
             ).setAttribute("checked", "checked");
            var L = function (e) {
             (t._loading = !0),
              t._loadingState(!0, !0),
