 ...
 n.length &&
  ((t = n.DataTable({
   ...
   buttons: [
         ...
         body: function (t, e, s) {
          ...
          return t.length <= 0
           ...
           : ((t = $.parseHTML(t)),
             (a = ""),
             $.each(t, function (t, e) {
              void 0 !== e.classList && e.classList.contains("product-name")
    ...
    {
     text:
      '<i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">Add Product</span>',
     ...
     this.api()
      ...
      .every(function () {
       ...
       e.data()
        ...
        .each(function (t, e) {
         s.append(
          '<option value="' + o[t].title + '">' + o[t].title + "</option>"
         );
        });
      }),
     this.api()
      ...
      .every(function () {
       ...
       e.data()
        ...
        .each(function (t, e) {
         s.append(
          '<option value="' + c[t].title + '">' + r[t].title + "</option>"
         );
        });
      });
   },
